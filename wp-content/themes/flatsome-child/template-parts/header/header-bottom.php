...
<div id="wide-nav" class="header-bottom wide-nav <?php header_inner_class('bottom'); ?>">
    <div class="flex-row container">
            ...
            <div class="flex-col hide-for-medium flex-left customize-menu">
                <div class="icon-default"><a href="<?php echo home_url(); ?>"><i class="fa-sharp fa-regular fa-house custom-font-icon-home"></i></a></div>
                ...
                <div class="more-icon"><a href="javascript:void(0);"><i class="fa-solid fa-grip-dots dot-more-menu"></a></i></div>
                <?php echo do_shortcode('[block id="menu-mega"]'); ?>
            </div><!-- flex-col -->
            <?php } ?>
